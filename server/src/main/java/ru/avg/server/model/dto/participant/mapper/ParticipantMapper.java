...
public class ParticipantMapper {
    ...
    public Participant fromDto(ParticipantDto participantDto) {
        ...
        return Participant.builder()
                ...
                .idDocument(participantDto.getIdDocument())
                .idDocumentData(participantDto.getIdDocumentData())
                .registrationAddress(participantDto.getRegistrationAddress())
                .nominalShare(participantDto.getNominalShare())
    ...
    public ParticipantDto toDto(Participant participant) {
        ...
        return ParticipantDto.builder()
                ...
                .idDocument(participant.getIdDocument())
                .idDocumentData(participant.getIdDocumentData())
                .registrationAddress(participant.getRegistrationAddress())
