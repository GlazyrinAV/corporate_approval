...
class ParticipantServiceImplTest {
    ...
    void findAllByMeetingType_ShouldReturnFilteredParticipants_ForFMSAndFMP() {
        ...
        when(participantRepository.findAllByCompanyId((companyId))).thenReturn(allParticipants);
    ...
    void findAllByMeetingType_ShouldReturnEmptyList_WhenNoParticipants() {
        // Given
        when(participantRepository.findAllByCompanyId((companyId))).thenReturn(Collections.emptyList());
    ...
    void findAll_ShouldReturnAllParticipants() {
        ...
        when(participantRepository.findAllByCompanyId((companyId))).thenReturn(participants);
